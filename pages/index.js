...
import nica from '../src/img/marcenica1.png'
...
const [darkMode, setDarkMode] = useState(false);
    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      <main>
        <section className='min-h-screen layout dark:bg-gray-700'>
          <nav className='py-10 mb-20 flex justify-between'>
            ...
            <ul className='flex items-center px-10 md:px-20 lg:px-40 '>
              ...
              <li><a className='amarelo text-black text-sm shadow-md px-3 py-2 ml-8 font-semibold' href="#contact">CONTACT</a></li>
            </ul>
          </nav>
            ...
            <div className='flex flex-col justify-center items-center h-96'>
              ...
              <h3 className='text:xl lg:text-2xl my-4 font-semibold'>Developer Front-End</h3>
        ...
        <section className='min-h-screen bg-white dark:bg-gray-700 flex justify-around' >
          ...
          <div className=' amarelo w-1/4 dark:bg-gray-800 flex flex-col items-center justify-center'>
            <div className=''>
          ...
          <div className='  w-3/4 flex px-60 flex-col p-20 justify-center items-center'>
            <div className='text-lg border-black border-2 py-1 px-2 shadow-lg dark:text-white dark:border-white font-semibold mb-5'>#aboutMe</div>
          <p className=' dark:text-gray-200 text-gray-800 md:text-md  mx-auto'>Brazilian, graduated in Marketing, estudo front end há alguns anos e tenho um pouco de conhecimento em back-end, além disso me interesso por games, robótica e deep learning. </p>
          
          <h4 className='text-5xl m-10 font-extrabold dark:text-white' >Skills</h4>
           
              <ul className='text-6xl   grid grid-cols-3 gap-10'>
                <li alt='HTML'><AiFillHtml5 className='text-orange-600'/></li>
  ...
  <section className='min-h-screen dark:bg-gray-700 layout px-10 md:px-20 lg:px-40 '>
    ...
    <div ><h2 className='text-5xl text-white font-semibold py-20'>Projects</h2></div>

        <div className='grid-cols-1 grid md:grid-cols-2 md:gap-10 px-20 dark:bg-gray-700 lg:grid-cols-3' >
            <div className='mb-20 flex flex-col justify-between text-start text-sm overflow-hidden max-w-xs h-96 bg-white shadow-xl rounded-md dark:bg-gray-800'>
        ...
        <section className='min-h-screen layout flex flex-col justify-between dark:bg-gray-700  '>
          ...
          <div className=' flex flex-row justify-around items-center z-10'>
            <div className='pt-60'>
              <h2 className='text-yellow-400 text-xl font-semibold mt-30 mb-4 dark:text-yellow-400'>Contact</h2>
